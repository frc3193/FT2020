...
y2->WhileHeld(new DoNothing());
a2.reset(new frc::JoystickButton(coPilot.get(), 1));
a2->WhileHeld(new DoNothing());
...
leftstickIn->WhileHeld(new IntakeForword());
leftBumper.reset(new frc::JoystickButton(driver.get(), 5));
leftBumper->WhileHeld(new IntakeReverse());
x.reset(new frc::JoystickButton(driver.get(), 3));
x->WhileHeld(new ElevatorForward());
b.reset(new frc::JoystickButton(driver.get(), 2));
b->WhileHeld(new ElevatorReverse());
...
/*
    frc::SmartDashboard::PutData("AutoTurn", new AutoTurn());
