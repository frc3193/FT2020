...
#include "Commands/AutoGoForwards.h"
...
optionsButton.reset(new frc::JoystickButton(coPilot.get(), 8));
...
rightButton2->WhenPressed(new ShooterToggle());
leftBumper2.reset(new frc::JoystickButton(coPilot.get(), 3));
leftBumper2->WhileHeld(new IntakeForword());
x2.reset(new frc::JoystickButton(coPilot.get(), 5));
x2->WhileHeld(new ElevatorForward());
b2.reset(new frc::JoystickButton(coPilot.get(), 3));
b2->WhileHeld(new ElevatorReverse());
y2.reset(new frc::JoystickButton(coPilot.get(), 4));
y2->WhenPressed(new Winchup());
x22.reset(new frc::JoystickButton(coPilot.get(), 5));
x22->WhileHeld(new IntakeReverse());
b22.reset(new frc::JoystickButton(coPilot.get(), 2));
b22->WhileHeld(new ElevatorReverse());
a2.reset(new frc::JoystickButton(coPilot.get(), 1));
a2->WhileHeld(new IntakeForward());
...
leftBumper->WhenPressed(new DriveReverse());
...
y->WhenPressed(new IntakeToggle());
a.reset(new frc::JoystickButton(driver.get(), 1));
a->WhenPressed(new ElevatorToggle());
*/
coPilot.reset(new frc::Joystick(1));
...
optionsButton->WhileHeld(new IntakeReverse());
rightStickIn2.reset(new frc::JoystickButton(coPilot.get(), 10));
rightStickIn2->WhenPressed(new IncreaseShooterSpeed());
leftStickIn2.reset(new frc::JoystickButton(coPilot.get(), 9));
leftStickIn2->WhenPressed(new DecreaseShooterSpeed());
rightButton2.reset(new frc::JoystickButton(coPilot.get(), 6));
rightButton2->WhenPressed(new ShooterToggle());
...
b2->WhileHeld(new ElevatorReverse());
y2.reset(new frc::JoystickButton(coPilot.get(), 4));
y2->WhileHeld(new Winchup());
a2.reset(new frc::JoystickButton(coPilot.get(), 1));
a2->WhileHeld(new IntakeForword());
a22.reset(new frc::JoystickButton(coPilot.get(), 1));
a22->WhileHeld(new ShooterUnity(-0.1));
a23.reset(new frc::JoystickButton(coPilot.get(), 1));
a23->WhileHeld(new ElevatorForward());
